...
%----------------------- титульный лист ------------------------
  ...
  Automation of research physics and technology chair
...
%-------------------------- введение --------------------------
  ...
  \section{Overview of the subject area}\label{sec:domain}
    ...
    very precise, and the result depends a lot on grid shape and spring locations, as well as on
    ...
    deformable body are found by interpolation of their values on elements of finite size.
  ...
  \section{Problem statement}\label{sec:task}
    ...
    virtual reality applications. The basic criteria to be followed are described in~\cite{gems-middleware}.
  ...
  \section{Modeling deformation}
    ...
    In this section the methods used for solving the problems stated are considered. Described are
    th chosen main algorithm for modeling plastic deformations of bodies, the improvements that were
    ...
    \subsection{Implementation of additional features}
      ...
      \subsubsection{Obtaining information about external forces}\label{sssec:external_forces}
